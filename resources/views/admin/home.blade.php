...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            <h2 style="margin: 10px 0 50px">Bienvenido empleado con usuario: {{ auth()->user()->name }}</h2>
                <div class="card z-index-2 " style="margin-bottom: 60px">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                      <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Gestión de mi empleado</h6>
                      </div>
                    </div>
                    <div class="card-body">
                        <a href="{{ url('empleadoshow') }}">Mostrar mi perfil</a><br><br>
                        <a class="nav-link pl-3" href="{{ url('empleadoedit') }}">Editar mi perfil</a>
                    </div>
                </div>
                ...
                <div class="card z-index-2 " style="margin-bottom: 60px">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('pedidoindexproductos') }}">Mostrar todos los productos vendidos</a>
                    </div>
                </div>
        </div>
        </div>
