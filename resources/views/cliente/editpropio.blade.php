  ...
  <div class="row">
      <div class="card card-plain">
        <div class="card-header">
            ...
            <h6 class="text-white text-capitalize ps-3">Edición del perfil de {{$cliente->nombre}} {{$cliente->apellidos}}</h6>
          </div>
        <!--</div>-->
        <div class="card-body">
            <form class="form-horizontal" action="{{ url('clienterupdate') }}" method="post" enctype="multipart/form-data">
        			@csrf
        			@method('put')
					<fieldset>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('nombre', $cliente->nombre) }}" id="nombre" name="nombre" type="text" class="form-control">
								@error('nombre')
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('apellidos', $cliente->apellidos) }}" id="apellidos" name="apellidos" type="text" class="form-control">
								@error('apellidos')
						            <div class="alert alert-danger">{{ $message }}</div>
						        @enderror
							</div>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('DNI', $cliente->DNI) }}" id="DNI" name="DNI" type="text" class="form-control">
								@error('DNI')
						            <div class="alert alert-danger">{{ $message }}</div>
						        @enderror
							</div>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('direccion', $cliente->direccion) }}" id="direccion" name="direccion" type="text" class="form-control">
								@error('direccion')
						            <div class="alert alert-danger">{{ $message }}</div>
						        @enderror
							</div>
		                    	...
		                    	<div class="input-group input-group-outline mb-3">
							        ...
							        <div class="col-md-9">
							            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $cliente->name) }}" required autocomplete="name">
							    ...
							    <div class="input-group input-group-outline mb-3">
							        ...
							        <div class="col-md-9">
							            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $cliente->email) }}" required autocomplete="email">
