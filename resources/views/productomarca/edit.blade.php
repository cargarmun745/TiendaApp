  ...
  <div class="row">
      <div class="card card-plain">
        <div class="card-header">
            ...
            <h6 class="text-white text-capitalize ps-3">Edición de la marca del producto {{$marca->nombre}}</h6>
          </div>
        <!--</div>-->
        <div class="card-body">
            <form class="form-horizontal" action="{{ url('marca/'.$marca->id) }}" method="post" enctype="multipart/form-data">
        			@csrf
        			@method('put')
					<fieldset>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('nombre', $marca->nombre) }}" id="nombre" name="nombre" type="text" placeholder="Nombre de marca" class="form-control">
								@error('nombre')
