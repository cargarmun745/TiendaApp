  ...
  <div class="row">
      <div class="card card-plain">
        <div class="card-header">
            ...
            <h6 class="text-white text-capitalize ps-3">Edición del tipo de producto {{$tipo->nombre}}</h6>
          </div>
        <!--</div>-->
        <div class="card-body">
            <form class="form-horizontal" action="{{ url('tipo/'.$tipo->id) }}" method="post" enctype="multipart/form-data">
        			@csrf
        			@method('put')
					<fieldset>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('nombre', $tipo->nombre) }}" id="nombre" name="nombre" type="text" placeholder="Nombre de tipo de producto" class="form-control">
								@error('nombre')
