  ...
  <div class="row">
      <div class="card card-plain">
        <div class="card-header">
            ...
            <h6 class="text-white text-capitalize ps-3">Creación de tipo de productos</h6>
          </div>
        <!--</div>-->
        <div class="card-body">
	            <form class="form-horizontal" action="{{ url('tipo') }}" method="post">
        			@csrf
					<fieldset>
						...
						<div class="input-group input-group-outline mb-3">
							...
							<div class="col-md-9">
								<input value="{{ old('nombre') }}" id="nombre" name="nombre" type="text" placeholder="Nombre del tipo de producto" class="form-control">
								@error('nombre')
