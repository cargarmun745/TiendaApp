...
@section('content')
  ...
  <div class="row">
    <div class="col-12">
              ...
              <tbody>
                    <tr>
                      ...
                      <td>
                    	...
                    	<td><p class="text-xs font-weight-bold mb-0">{{ $empleado->name }}</p></td>
                    	<td><p class="text-xs font-weight-bold mb-0">{{ $empleado->email }}</p></td>
      ...
      @if(isset($empleado->nombrecargo))
      <div class="col-6" style="margin-top: 40px">
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Cargo del empleado</h6>
          </div>
        </div>
        <div class="card-body px-0 pb-2">
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0 table-hover">
              ...
              <tbody>
                    <tr>
                      <td></td>
                      <td><p class="text-xs font-weight-bold mb-0">{{ $empleado->nombrecargo }}</p></td>
                      <td><p style="max-width: 120px" class="text-xs font-weight-bold mb-0">{{ $empleado->descripcioncargo }}</p></td>
    		            </tr>
              </tbody>
            </table>
          </div>
      ...
      @endif
      <a href="{{ url('home') }}" class="btn btn-lg bg-gradient-primary btn-lg mt-4 mb-0">
					Volver atras
			</a>
    </div>
  </div>
