                ...
                @foreach ($pedidos as $pedido)
                    <tr>
                      ...
                      <td class="pull-right" style="width: 320px">
                        <a href="javascript: void(0);" data-name="{{ $pedido->fechaPedido }}" data-table="pedido con fecha" data-url="{{ url('pedidodelete/' . $pedido->id) }}" data-bs-toggle="modal" data-bs-target="#modalDelete"  class="btn btn-link text-danger text-gradient px-3 mb-0" ><i class="material-icons text-sm me-2">delete</i>Delete</a>
                        <a class="btn btn-link text-dark px-3 mb-0" href="{{ url('pedidoedit/'.$pedido->id) }}"><i class="material-icons text-sm me-2">edit</i>Edit</a>
                        <a class="btn btn-link text-dark px-3 mb-0" href="{{ url('pedidoshow/'.$pedido->id) }}">
